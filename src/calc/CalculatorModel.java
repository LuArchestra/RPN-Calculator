...
public class CalculatorModel implements Calculator {
    ...
    public List<Double> getStack() {
    	List<Double> captureMemory = new ArrayList<>(memory);
    	Collections.reverse(captureMemory);		// On renverse la liste, pour avoir un LIFO facile a manipuler
    	return  captureMemory;
    }
    // Lors de l'assignation aux textFields, on va pouvoir vider la stack du haut vers le bas.
